...
#define RT_CLUSTER_TASK_NB_ARG                (2*4)
#define RT_CLUSTER_TASK_STACKS                (3*4)
#define RT_CLUSTER_TASK_STACK_SIZE            (4*4)
#define RT_CLUSTER_TASK_SLAVE_STACK_SIZE      (5*4)
#define RT_CLUSTER_TASK_NB_CORES              (6*4)
#define RT_CLUSTER_TASK_COMPLETION_CALLBACK   (7*4)
#define RT_CLUSTER_TASK_STACK_ALLOCATED       (8*4)
