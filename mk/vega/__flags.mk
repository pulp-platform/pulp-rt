...
PULP_FC_CFLAGS    += -Wextra -Wall -Wno-unused-parameter -Wno-unused-variable -Wno-unused-function -Wundef -fdata-sections -ffunction-sections -I$(TARGET_INSTALL_DIR)/include/io -I$(TARGET_INSTALL_DIR)/include -include $(CURDIR)/mk/vega/fc_config.h
