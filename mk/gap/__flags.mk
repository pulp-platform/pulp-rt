...
PULP_CL_CFLAGS    += -Wextra -Wall -Wno-unused-parameter -Wno-unused-variable -Wno-unused-function -Wundef -fdata-sections -ffunction-sections -I$(TARGET_INSTALL_DIR)/include/io -I$(TARGET_INSTALL_DIR)/include -I$(TARGET_INSTALL_DIR)/include -include rt/chips/gap/config.h
...
PULP_FC_CFLAGS    += -Wextra -Wall -Wno-unused-parameter -Wno-unused-variable -Wno-unused-function -Wundef -fdata-sections -ffunction-sections -I$(TARGET_INSTALL_DIR)/include/io -I$(TARGET_INSTALL_DIR)/include -I$(TARGET_INSTALL_DIR)/include -include rt/chips/gap/config.h
