 ...
 */
#ifndef __PMSIS_PINMAP_H__
#define __PMSIS_PINMAP_H__
...
typedef struct {
    uint32_t count;
    const pin_name_e *pins;
} pin_list;

void pin_function(pin_name_e pin, int function);
void pin_mode(pin_name_e pin, pin_mode_e mode);

uint32_t pinmap_peripheral(pin_name_e pin, const pin_map *map);
uint32_t pinmap_function(pin_name_e pin, const pin_map *map);
uint32_t pinmap_merge(uint32_t a, uint32_t b);
void     pinmap_pinout(pin_name_e pin, const pin_map *map);
uint32_t pinmap_find_peripheral(pin_name_e pin, const pin_map *map);
uint32_t pinmap_find_function(pin_name_e pin, const pin_map *map);
 ...
 *     const pin_list *pins_ff = pinmap_ff_default_pins();
 *     const pin_list *pins_avoid = pinmap_restricted_pins();
 *     pin_name_e mosi = NC;
 *     pin_name_e miso = NC;
 *     pin_name_e sclk = NC;
 *     pin_name_e ssel = NC;
 ...
 */
int pinmap_find_peripheral_pins(const pin_list *whitelist, const pin_list *blacklist, int per, const pin_map *const *maps, pin_name_e **pins, uint32_t count);
 ...
 */
int pinmap_list_has_pin(const pin_list *list, pin_name_e pin);
 ...
 */
const pin_list *pinmap_restricted_pins(void);
 ...
 */
const pin_list *pinmap_ff_arduino_pins(void);
 ...
 */
const char *pinmap_ff_arduino_pin_to_string(pin_name_e pin);
 ...
 */
const pin_list *pinmap_ff_default_pins(void);
 ...
 * @return String representing the form factor pin
 */
const char *pinmap_ff_default_pin_to_string(pin_name_e pin);
